    ...
    <div className="flex h-[calc(100svh-3.5rem)] flex-col">
      <div className="flex items-center justify-between border-b border-border px-4 py-2">
        <h1 className="flex items-center gap-2 text-sm font-medium">
          ...
          Agent 模式
          <span className="text-muted-foreground">· ReAct + 工具调用 · SSE 流式</span>
        </h1>
      ...
      <div className="flex-1 overflow-y-auto scrollbar-thin">
        {messages.length === 0 ? (
          <div className="mx-auto flex h-full max-w-3xl flex-col items-center justify-center px-4 py-10 text-center">
            ...
            <h2 className="mt-5 text-2xl font-semibold tracking-tight">Agent 自主烹饪助手</h2>
            ...
            <div className="mt-8 flex w-full max-w-xl flex-col gap-2">
              {AGENT_SUGGESTIONS.map((s) => (
                <button
                  ...
                  disabled={sending}
                  className="group flex items-start gap-3 rounded-xl border border-border bg-card p-4 text-left transition-colors hover:border-primary/40 hover:bg-accent/40 cursor-pointer disabled:opacity-50"
                >
